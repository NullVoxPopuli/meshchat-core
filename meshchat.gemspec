...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'rbnacl-libsodium',        '>= 1.0.10'
  s.add_runtime_dependency 'rbnacl',                  '>= 3.4.0'
  s.add_runtime_dependency 'ripl-readline-em'
  s.add_runtime_dependency 'action_cable_client',     '>= 1.3.2'
  s.add_runtime_dependency 'i18n',                    '>= 0.7.0'
  s.add_runtime_dependency 'libnotify',               '>= 0.9.1'
