...
describe Meshchat::Configuration::Settings do
  let(:klass) { Meshchat::Configuration::Settings }

  before(:each) do
    allow_any_instance_of(Meshchat::Configuration::Settings).to receive(:filename) { 'test-settings' }
  end
